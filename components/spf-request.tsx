...
export default function SPF({ processBy }: SPFProps) {
    ...
    useEffect(() => {
        ...
        const filtered = products.filter((p: any) => {
            ...
            const commercial = JSON.stringify(p.details?.commercialDetails || "").toLowerCase();
                    ...
                    requests.map((req) => {
                        ...
                        return (
                            <div key={req.id} className="grid grid-cols-5 py-2 border-b text-sm items-center">
                                ...
                                <div>
                                    <span className="text-xs px-2 py-1 rounded bg-gray-100 uppercase">{req.special_instructions || "-"}</span>
                                </div>
                                        ...
                                        <table className="w-full table-auto border">
                                            <thead>
                                                <tr className="bg-gray-100">
                                                    ...
                                                    <th className="border px-2 py-1 text-left">Product Offer</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                {(formData.item_description || []).map((desc, index) => {
                                                    ...
                                                    return (
                                                        <tr key={index} className="text-sm">
                                                            ...
                                                            <td className="border px-2 py-1">{formData.item_code?.[index] || "-"}</td>
                                                            <td
                                                        ...
                                                        return (
                                                            <>
                                                                {details.factoryAddress && (
                                                                    <p>
                                                                        <span className="font-medium">Factory:</span> {details.factoryAddress}
                                                                    </p>
                                                                )}

                                                                {details.portOfDischarge && (
                                                                    <p>
                                                                        <span className="font-medium">Port:</span> {details.portOfDischarge}
                                                                    </p>
                                                                )}

                                                                {details.unitCost && (
                                                                    <p>
                                                                        <span className="font-medium">Unit Cost:</span> {details.unitCost}
                                                                    </p>
                                                                )}

                                                                {(packaging.height || packaging.length || packaging.width || packaging.pcsPerCarton) && (
                                                                    <div>
                                                                        ...
                                                                        <ul className="ml-3 list-disc">
                                                                            ...
                                                                            {packaging.pcsPerCarton && <li>PCS/Carton: {packaging.pcsPerCarton}</li>}
                                                                        </ul>
                                                                    </div>
                                                                )}
                                                            </>
